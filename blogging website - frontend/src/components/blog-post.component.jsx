        ...
        >
            ...
            <div className="flex flex-col justify-between p-6 md:p-8 w-full">
                ...
                <div className="flex flex-col gap-2">
                    <h2 className="text-2xl md:text-3xl font-extrabold text-gray-900 group-hover:text-purple-600 transition-colors duration-500 line-clamp-2 animate-slideUp">
                        {title}
                    </h2>
