...
const PublishForm = () => {
    ...
    return (
        <AnimationWrapper>
            ...
            {/* ------------------------------ NAVBAR ------------------------------ */}
            <nav className="navbar fixed top-0 left-0 right-0 z-20 flex items-center p-4 bg-bg-nav backdrop-blur-md shadow-sm">
            ...
            {/* ------------------------------ MAIN LAYOUT ------------------------------ */}
            <section className="pt-20 min-h-screen bg-bg-main grid grid-cols-1 lg:grid-cols-3">

                {/* --------------------------- LEFT: PREVIEW --------------------------- */}
                <div className="lg:col-span-2 px-4 md:px-8 lg:px-16 py-10 bg-bg-list border-r border-grey">
                ...
                <div className="px-4 md:px-8 py-10 bg-bg-main">
                    <div className="max-w-[420px] mx-auto space-y-6">
                        ...
                        {/* TITLE */}
                        <div>
                            <p className="mb-2 text-gray-300 font-medium">Blog Title</p>
                            <input
                                type="text"
                                defaultValue={title}
                                onChange={handleBlogTitleChange}
                                maxLength={100}
                                className="w-full bg-bg-list border border-grey rounded-lg p-3 outline-none focus:border-black transition"
                            />
                        </div>
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                className="w-full bg-bg-list border border-grey rounded-lg p-3 resize-none outline-none focus:border-black transition"
                            />
