        ...
        <>
            ...
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-6">
                    ...
                    <button className="group flex items-center gap-2 text-grey hover:text-blue-500 transition" onClick={() => { setCommentsWrapper(preVal => !preVal) }}>
                ...
                <div className="relative" ref={shareRef}>
                    <div className="flex items-center gap-3">
                        {username === author_username && (
                            <Link
                                to={`/editor/${blog_id}`}
                                className="text-dark ext-sm underline hover:text-purple"
                            >
                                Edit
                            </Link>
                        )}
                        ...
                        >
                            <i className="text-dark fi fi-rr-share-square text-lg"></i>
                        </button>
                    </div>
